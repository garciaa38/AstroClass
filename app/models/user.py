...
class User(db.Model, UserMixin):
    ...
    user_post_rel = db.relationship('Post', backref='user', lazy=True)
    user_post_reply_rel = db.relationship('PostReply', backref='user', lazy=True)
...
class Post(db.Model):
    ...
    post_user_rel = db.relationship("User", backref="posts", lazy=True)
